...
LABEL "org.opencontainers.image.source"="https://github.com/eyerate-actions/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/eyerate-actions/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/eyerate-actions/action-slack-notify
